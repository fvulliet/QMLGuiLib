...
# check effective use of android toolchain
if (NOT ANDROID)
  message(FATAL_ERROR "Trying to build APK without any android toolchain (ANDROID variable is not set to true as it should be with an android toolchain which enable cross compilation).")
endif()
...
#
# example:
# create_qt_android_apk(my_app_apk my_app
#     NAME "My App"
#     VERSION_CODE 12
...
#)
# 
macro(create_qt_android_apk TARGET SOURCE_TARGET)
    ...
    # ANDROID_SDK_BUILDTOOLS_REVISION is already setted from the toolchain
    set(QT_ANDROID_SDK_BUILDTOOLS_REVISION ${ANDROID_SDK_BUILDTOOLS_REVISION})
    ...
    file(MAKE_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI})
    ...
    add_custom_target(
        ...
        COMMAND ${CMAKE_COMMAND} -E remove_directory ${CMAKE_CURRENT_BINARY_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI} # it seems that recompiled libraries are not copied if we don't remove them first
        COMMAND ${CMAKE_COMMAND} -E make_directory ${CMAKE_CURRENT_BINARY_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI}
        COMMAND ${CMAKE_COMMAND} -E copy ${QT_ANDROID_APP_PATH} ${CMAKE_CURRENT_BINARY_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI}
